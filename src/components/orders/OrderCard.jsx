...
export default function OrderCard({ order, onPress, variant = "light" }) {
  ...
  // 💡 Clean Format: "Jollof Rice (1)" instead of "1x Jollof Rice"
  const itemSummary =
    itemCount === 0
      ? "No items"
      : order.items
  ...
  return (
    ...
    >
      ...
      <View style={styles.itemsContainer}>
        <Text style={[styles.items, isDark && styles.textMuted]} numberOfLines={1}>
          {itemSummary}
        </Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  cardLight: { backgroundColor: COLORS.white, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 3 },
  cardDark: { backgroundColor: COLORS.stone, borderWidth: 1, borderColor: COLORS.border },
  header: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: SPACING.sm },
  headerLeft: { flexDirection: "row", alignItems: "center", gap: SPACING.sm },
  orderId: { fontSize: FONT_SIZES.sm, fontWeight: "700", color: COLORS.dark, letterSpacing: 1 },
  timeAgo: { fontSize: FONT_SIZES.xs, color: COLORS.muted },
  customerName: { fontSize: FONT_SIZES.md, fontWeight: "700", color: COLORS.dark, marginBottom: SPACING.xs },
  itemsContainer: { marginBottom: SPACING.md },
  items: { fontSize: FONT_SIZES.sm, color: COLORS.muted },
  footer: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  address: { fontSize: FONT_SIZES.xs, color: COLORS.muted, flex: 1, marginRight: SPACING.sm },
